  ...
  return (
    <ScreenFrame className="bg-primary/30" frameClassName="text-center">
      <motion.div
        ...
        animate="show"
        exit="hidden"
        className="cyber-panel mx-auto max-w-xl rounded-[2rem] border border-white/10 bg-white/[0.035] px-6 py-10 shadow-[0_0_55px_rgba(47,132,255,0.08)] backdrop-blur-md"
      >
        ...
        <p className="mb-8">
          The portfolio had trouble loading this page. Return to the homepage
